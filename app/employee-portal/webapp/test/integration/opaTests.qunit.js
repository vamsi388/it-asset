...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "employeeportal/test/integration/FirstJourney",
    "employeeportal/test/integration/ServiceRequestsListJourney",
    "employeeportal/test/integration/ServiceRequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
