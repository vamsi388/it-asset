...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "itagentdashboard/test/integration/FirstJourney",
    "itagentdashboard/test/integration/ServiceRequestsListJourney",
    "itagentdashboard/test/integration/ServiceRequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
