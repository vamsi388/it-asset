...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "analyticals/test/integration/FirstJourney",
    "analyticals/test/integration/TicketAnalyticsListJourney",
    "analyticals/test/integration/TicketAnalyticsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
